...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Ponto 2 esta no eixo Y ? " + ponto2.isEixoY()); // imprime false
        System.out.println("Ponto 1 esta na origem ? " + ponto1.isEixos()); // imprime false
        System.out.println("Ponto 2 esta na origem ? " + ponto2.isEixos()); // imprime false
    
        System.out.println("O quadrante do ponto 1 eh " + ponto1.quadrante()); // imprime 1
        System.out.println("O quadrante do ponto 2 eh " + ponto2.quadrante()); // imprime 2
    
        DecimalFormat df = new DecimalFormat("#.##");
        System.out.println("A distancia entre os pontos eh (aproximadamente) " + df.format(ponto1.distancia(ponto2))); // imprime 3,61  
    }
}
